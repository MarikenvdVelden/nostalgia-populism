...
Finally, we test the persuasiveness of nostalgia as a rhetorical style through a pre-registered vignette experiment.
...
We have used the recommendation of Gerber and Green (2011) to impute missing values with the mean value per wave, and indicate if a variable has more than ten percent missing values.
...
Respondents could select any of the four texts we created for the experiment (see our [Online Compendium](X)).
...
Messages can either be nostalgic or not, as well as consist of a scapegoat or not -- creating four experimental groups, see our [Online Compendium](X).
...
***Control Variables.*** Based on a balance test (see our [Online Compendium](X) for details), we included unbalanced demographic covariates as well as the ideological tone of the experimental message, whether it was a nostalgic and/or scapegoat message into our analysis.
...
All analytical material is published in our [Online Compendium](X).
