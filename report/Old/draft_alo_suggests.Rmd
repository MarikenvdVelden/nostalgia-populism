...
At the same time, left-wing leaders, like Jean-Luc Mélenchon (*La France Insoumise*) [@buffery2012], also reminisce about the hope that lies in the past.
...
Third, in a preregistered vignette experiment,^[Our online compendium combines the data and the preregistration: https://github.com/MarikenvdVelden/nostalgia-populism] we show that overall respondents like nostalgic messages, but not more so than non-nostalgic messages.
...
This study makes several important theoretical and empirical contributions. First, in the field of the political communication, we theorise and find evidence that the central role nostalgia plays in political communication goes way beyond the concept of collective nostalgia [@smeekes2015longing; @sedikides2019sociality; @wohl2020longing].
The nostalgic desire to "return to community" is present across the ideological spectrum, although often not only reluctant but also progressive and playful. All in all, nostalgia evokes a sense of belonging, which is pivotal for people to carry out their democratic citizenship [@blajer2023conceptualizing]. 
Second, this paper contributes to research on rhetorical persuasiveness. Our empirical findings provide a nuanced understanding on the extent to which nostalgia can be effective to engage voters. We show that even if thinking nostalgia is persuasive is a commonplace across voters from different ideologies, it does not increase the liking of in-party political messages.

We posit that the findings of our research hold key implications for contemporary democratic societies and the well-being of individuals. Based on the shared misperception that nostalgia is an effective tool for political persuasion, political actors might be exacerbating social divisions and individuals' disatisfaction. On one hand, nostalgia, particularly of the reluctant variety, has the potential to heighten inter-group tensions (Smeekes, 2015). This effect can polarize communities, as it often romanticizes a past that excludes certain groups, thereby exacerbating divisions within society. On the other hand, our results suggest that nostalgia can adversely impact individual well-being and the quality of social interactions  (Sedikides et al, 2008; Juhl et al, 2010). 
...
We have used the recommendation of Gerber and Green (2011) to impute missing values with the mean value per wave, and indicate whether a variable has more than ten percent missing values.^[Our analytical code is available on our Online Compendium: https://github.com/MarikenvdVelden/nostalgia-populism] 
...
We report the results with imputed missing values, but our [Online Compendium](https://github.com/MarikenvdVelden/nostalgia-populism) also presents the analyses without imputed values, and these results are substantively similar.
...
Messages can either be nostalgic or not, as well as consist of a scapegoat or not (i.e. a `2*2` design) -- creating four experimental groups, see our [Online Compendium](https://github.com/MarikenvdVelden/nostalgia-populism).
...
The results, reported in the [Online Compendium](https://github.com/MarikenvdVelden/nostalgia-populism), are not affected by this choice.
...
An important implication of this research is the revelation that the widespread adoption of nostalgic narratives by populist actors could stem from a misperception of these narratives as more effective than other rhetorical strategies. This insight is crucial, given that evidence links reluctant nostalgia not only to increased resentment between social groups (Smeekes, 2015) but also to adverse effects on personal well-being (Sedikides et al, 2008) and an amplification of existential threats (Juhl et al, 2010).

Building on these findings, we invite future researchers to examine the extent to which not only populist actors but also mainstream political parties and media outlets employ nostalgia, including its playful and progressive variants, to engage and attract voters. The differential impacts of these nostalgia types on societal cohesion and individual well-being merit closer investigation. 
